/**
 * @file Arduino_Wireless_Wristband.ino
 * @brief An Arduino script for Wi-Fi communication to control NeoPixel LED colors remotely based on numeric commands (1, 2, 3, 4).
...
void loop() {
  ...
  if (client) {
    ...
    while (client.connected()) {
      if (client.available()) {
        char c = client.read();
        // Handle numeric commands for LED colors
        if (c == '1') {
